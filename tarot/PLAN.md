# Tarot Plan（冻结 v0.7 · 2026-09-10）

> 实现状态：P0–P5 已落地（牌库、仪式、解读/追问、历史、额度与登录）。AI 默认 mock，gateway 已接线（`AI_PROVIDER=gateway`）。剩余主要为 P6 动画、卡面美化、可选流式 UI、GitHub 自动部署。产品决策仍按下表冻结。
