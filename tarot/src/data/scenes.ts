...
export const SCENES: {
...
}[] = [
  {
    ...
    tonePrompt:
      "口吻偏柔：像烛边低语，优先看见情绪与关系张力；少下对错判断，多用「可能感到」「值得留意」。",
  ...
  },
  {
    ...
    defaultSpread: "three_card",
    tonePrompt: "口吻偏稳：沉稳有边界，像安静桌上谈路径与取舍；少煽情比喻，多对照「能做的一步」与「暂缓的」。",
  ...
  },
  {
    ...
    defaultSpread: "three_card",
    tonePrompt: "口吻偏鼓励但不催：点明卡点后只给一个可执行的一小步；忌长篇说教。",
  ...
  },
  {
    ...
    defaultSpread: "three_card",
    tonePrompt: "口吻偏中性冷静：帮看清互动模式与自己的位置；少站队、少情绪渲染。",
  ...
  },
  {
    ...
    tonePrompt: "口吻偏短直：一两句对照即可，不铺叙事；先摆两边，再点「当下更值得听从的」。",
  ...
  },
  {
    ...
    defaultSpread: "three_card",
    tonePrompt: "口吻偏慢柔：强调照顾与边界，像慢烛火；不制造恐慌，不诊断。",
...
export const CUSTOM_SCENE = {
  ...
  tonePrompt: "口吻温和、具体：以本局牌阵为锚，可延伸为顾问对话；勿写成泛化鸡汤。",
