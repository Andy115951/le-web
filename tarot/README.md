...
**P0–P46 已落地**（v2.25）；**P47–P51 体验队列待做**（见 `PLAN.md` / `DEV.md` / `SOAK.md`）。含仪式起卦、流式解读/追问、78 张 `CARD_ART`、牌义图鉴、OAuth、静默模式、场景微剧本、分享/信物预览、克制多局记忆、PWA、真机浸泡、首次来访引导、访客登录转化、历史好找（场景/时间/同题成组/软收藏）等。生产：https://candle-taro.vercel.app
