...
test("research flow replays only safe stage summaries from an exactly linked capture run", function () {
  const flow = buildResearchFlowReplay({
    ...
    captureTasks: [
      ...
      { task_kind: "daily_fact_report", task_version: "daily-research-report-v1", status: "succeeded", attempt: 2, queue_delay_ms: 1250, duration_ms: 900, created_at: "2026-08-12T00:01:00.000Z", details: { created: true, raw: "must-not-appear" } },
